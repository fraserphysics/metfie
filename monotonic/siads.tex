...
\begin{itemize}
\item Understand difference between analytic eigenfunctions and
...
eigenvalue is $1$.  If $\tau = \frac{1}{2}$, then
\begin{equation*}
  \leftfunction_\tau(g) =
  \begin{cases}
    1 & g \leq \frac{1}{2} \\
...
\begin{align*}
  \lambda_\tau \leftfunction_\tau (g=0) &= \left( \leftfunction_\tau
                                          \Aop_\tau \right) (g=0) \\ 
  \lambda_\tau &= \left( \frac{1}{2} + \int_{\frac{1}{2}}^1
                1 + \frac{1}{\lambda}\left( \frac{1}{2} - h \right)
                dh \right) \\
...
\begin{subequations}
  ...
  \begin{align}
    ...
    \leftfunction_{\frac{1}{n}}(g) = who knows \\
    \rightfunction_0(g) &= who knows,
  \end{align}
\end{subequations}
and
\begin{equation}
...
for a few values of $n$.\marginpar{FixMe}

\begin{figure*}
  \centering
  \resizebox{0.75\textwidth}{!}{\includegraphics{eigenfunctions.pdf}}
  \caption{Eigenfunctions FixMe bogus of $\Aop_\tau$ with $\tau=\frac{1}{n}$ for
    several values of $n$.}
