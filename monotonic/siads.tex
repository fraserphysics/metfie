...
\begin{equation}
  ...
  \frac{1}{e}.
\end{equation}
Figure~\ref{fig:eigenfunctions} illustrates $\leftfunction_{\frac{1}{n}}$ for a
few values of $n$.
...
\end{equation}
exists.  Since the analysis in Section~\ref{sec:continuous_g} leading
to Equations~\eqref{eq:limit_function} and \eqref{eq:limit_value}
gives the value $\lim_{\tau \rightarrow 0} \lambda_\tau = 1 -
\frac{1}{e}$ and suggests that $\lim_{\tau \rightarrow 0}
\rightfunction_\tau$ exists, all that remains is to show that
\begin{equation}
  \label{eq:3}
