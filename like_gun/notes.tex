...
\label{sec:optimization}
 ...
 and for each I will have a module with
  code that generates simulated data and that given data and an EOS
...
\begin{figure}
  \centering
    ...
    \caption{Maximum likelihood estimation of $f$.  The \emph{true}
      ...
      in the velocity time series after each step in the optimization
