...
\item[set\_Be] Map experimental velocities v and times t to the
  ...
  \begin{figure}
    ...
    \caption{The product $B D$.  Each trace represents
      ...
      approximation errors and not integration errors.  Plots of the
      derivative of energy, ie,
      $\frac{\partial E(t)}{\partial c_f[i]}$ increase monotonically.}
    \label{fig:BD_test}
  \end{figure}
...
\item[opt] Do a constrained optimization step.  The goal of \emph{opt}
  ...
  \begin{figure}
    \centering
    \resizebox{.7\columnwidth}{!}{\includegraphics{opt_result.pdf}}  
