...
Figures\ \ref{fig:Av1}-\ref{fig:Av3} illustrate the action
\begin{figure*}
  \centering
    \resizebox{1.2\textwidth}{!}{\includegraphics{Av1.pdf}}
  \caption{Caption}
  \label{fig:Av1}
\end{figure*}
...
\begin{figure*}
  \centering
    \resizebox{1.2\textwidth}{!}{\includegraphics{Av2.pdf}}
  \caption{Caption}
  \label{fig:Av2}
\end{figure*}
...
\begin{figure*}
  \centering
    \resizebox{1.2\textwidth}{!}{\includegraphics{Av3.pdf}}
  \caption{Caption}
  \label{fig:Av3}
\end{figure*}
...
\onecolumn
\section{Attempts to Solve the Integral Equation}
\label{sec:solve}
